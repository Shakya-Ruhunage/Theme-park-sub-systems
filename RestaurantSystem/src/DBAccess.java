...
public class DBAccess {
    ...
    public static boolean customerDoesRestaurant(String tagId, String restId, String price) {
        try {
            conn = DatabaseConnection.getInstance();
        } catch (SQLException e) {
            e.printStackTrace();
        ...
        query = "INSERT INTO cus_does_photo(Tag_id, res_id,Price) values(?,?,?)";
    ...
    public static int updateBalance(int balance, String tagId) {
        try {
            conn = DatabaseConnection.getInstance();
        } catch (SQLException e) {
            e.printStackTrace();
